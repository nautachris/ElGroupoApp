...
namespace ElGroupo.Domain.Migrations
{
    ...
    [Migration("20170810201832_changedNames")]
    partial class changedNames
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("ElGroupo.Domain.ContactGroupUser", b =>
                {
                    ...
                    b.Property<long>("ElGroupoUserId");

                    b.Property<int?>("ElGroupoUserId1");
            ...
            modelBuilder.Entity("ElGroupo.Domain.ElGroupoUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ElGroupo.Domain.ContactGroup", b =>
                {
                    b.HasOne("ElGroupo.Domain.ElGroupoUser")
            ...
            modelBuilder.Entity("ElGroupo.Domain.ContactGroupUser", b =>
                {
                    b.HasOne("ElGroupo.Domain.ElGroupoUser", "ElGroupoUser")
                        .WithMany()
                        .HasForeignKey("ElGroupoUserId1");
            ...
            modelBuilder.Entity("ElGroupo.Domain.EventAttendee", b =>
                {
                    ...
                    b.HasOne("ElGroupo.Domain.ElGroupoUser", "User")
            ...
            modelBuilder.Entity("ElGroupo.Domain.EventGroup", b =>
                {
                    b.HasOne("ElGroupo.Domain.ElGroupoUser", "Owner")
            ...
            modelBuilder.Entity("ElGroupo.Domain.MessageBoardItem", b =>
                {
                    ...
                    b.HasOne("ElGroupo.Domain.ElGroupoUser", "PostedByUser")
                        .WithMany()
